...
class DatabaseSettingsTab(QWidget):
    def __init__(self):
        ...
        grid_layout.addWidget(self.similarity_label, 0, 2)
        grid_layout.addWidget(self.similarity_edit, 0, 3)
        ...
        grid_layout.addWidget(self.contexts_label, 0, 4)
        grid_layout.addWidget(self.contexts_edit, 0, 5)
        ...
        grid_layout.addWidget(self.search_term_label, 1, 0)
        grid_layout.addWidget(self.search_term_edit, 1, 1)
        grid_layout.addWidget(self.filter_button, 1, 2)
        ...
        grid_layout.addWidget(QLabel("File Type:"), 1, 3)
        grid_layout.addWidget(self.file_type_combo, 1, 4)
